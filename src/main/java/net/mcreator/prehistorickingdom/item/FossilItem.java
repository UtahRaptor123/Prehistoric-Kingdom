...
public class FossilItem extends PrehistoricKingdomModElements.ModElement {
	@ObjectHolder("prehistoric_kingdom:fossil")
	public static final Item block = null;
	public FossilItem(PrehistoricKingdomModElements instance) {
		super(instance, 6);
	}
