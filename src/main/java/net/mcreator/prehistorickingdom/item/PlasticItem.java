...
public class PlasticItem extends PrehistoricKingdomModElements.ModElement {
	@ObjectHolder("prehistoric_kingdom:plastic")
	public static final Item block = null;
	public PlasticItem(PrehistoricKingdomModElements instance) {
		super(instance, 23);
	}
