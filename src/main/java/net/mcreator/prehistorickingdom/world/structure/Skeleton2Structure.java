...
package net.mcreator.prehistorickingdom.world.structure;
...
public class Skeleton2Structure extends PrehistoricKingdomModElements.ModElement {
	public Skeleton2Structure(PrehistoricKingdomModElements instance) {
		super(instance, 42);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 2000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("prehistoric_kingdom", "skeleton2"));
						if (template == null)
							return false;
