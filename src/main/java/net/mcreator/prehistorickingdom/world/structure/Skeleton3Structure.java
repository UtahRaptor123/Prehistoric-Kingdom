...
public class Skeleton3Structure extends PrehistoricKingdomModElements.ModElement {
	public Skeleton3Structure(PrehistoricKingdomModElements instance) {
		super(instance, 43);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 2000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("prehistoric_kingdom", "skeleton3"));
						if (template == null)
							return false;
