...
public class Skeleton5Structure extends PrehistoricKingdomModElements.ModElement {
	public Skeleton5Structure(PrehistoricKingdomModElements instance) {
		super(instance, 45);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 2000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("prehistoric_kingdom", "skeleton5"));
						if (template == null)
							return false;
