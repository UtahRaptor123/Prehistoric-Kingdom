...
public class Skeleton4Structure extends PrehistoricKingdomModElements.ModElement {
	public Skeleton4Structure(PrehistoricKingdomModElements instance) {
		super(instance, 44);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 2000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("prehistoric_kingdom", "skeleton4"));
						if (template == null)
							return false;
