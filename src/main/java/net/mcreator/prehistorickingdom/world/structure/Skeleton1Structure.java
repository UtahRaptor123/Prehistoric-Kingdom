...
public class Skeleton1Structure extends PrehistoricKingdomModElements.ModElement {
	public Skeleton1Structure(PrehistoricKingdomModElements instance) {
		super(instance, 41);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 50) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("prehistoric_kingdom", "rat"));
						if (template == null)
							return false;
