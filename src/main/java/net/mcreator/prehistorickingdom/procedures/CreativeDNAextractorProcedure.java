...
public class CreativeDNAextractorProcedure extends PrehistoricKingdomModElements.ModElement {
	public CreativeDNAextractorProcedure(PrehistoricKingdomModElements instance) {
		super(instance, 15);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure CreativeDNAextractor!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure CreativeDNAextractor!");
			return;
		}
