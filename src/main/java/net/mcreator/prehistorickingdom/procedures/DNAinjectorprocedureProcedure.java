...
import net.mcreator.prehistorickingdom.item.BluechickendnaItem;
...
public class DNAinjectorprocedureProcedure extends PrehistoricKingdomModElements.ModElement {
	public DNAinjectorprocedureProcedure(PrehistoricKingdomModElements instance) {
		super(instance, 33);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure DNAinjectorprocedure!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure DNAinjectorprocedure!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure DNAinjectorprocedure!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure DNAinjectorprocedure!");
			return;
		}
		...
		if ((100 <= (new Object() {
			...
			if ((200 <= (new Object() {
				...
				if (((new ItemStack(BluechickendnaItem.block, (int) (1)).getItem() == (new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						&& (new ItemStack(PlasticchickeneggBlock.block, (int) (1)).getItem() == (new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
